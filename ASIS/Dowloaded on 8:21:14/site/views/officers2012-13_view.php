<section class="container" id="officers-header">
	<div class="row">
		<div class="twelvecol">
			<img src="<?php echo base_url("images/"); ?>/officers/main.jpg" title="USC ASIS 2011-2012 Officers" />
		</div>
...
<section class="container" id="officers">
	<div class="row">
		<div class="twelvecol">
			<h1>Officers 2012-2013</h1> Previous Officer >> <a href="/officers_view.php">2011-2012</a>
			<hr/>
		</div>
			
		<?php foreach($officers2012-13 as $officer): ?>
